...
```{r}
f <- carbono_xxx_xxx_xxx ~ slope + plan_curvature + profile_curvature + twi + catchment_area + catchment_slope + elevation + CE37 + CE75 + ndvi_2013_04_22 + ndvi_2016_01_25 + ndvi_2018_04_20 + ndvi_variation + fields + water_tank_dist + camada_id
```
...
```{r}
covar_data$fields <- as.factor(covar_data$fields)
pred_100 <- 
  covar_data %>% 
  predict(fit_rf_100)
mapview(pred_100) + 
